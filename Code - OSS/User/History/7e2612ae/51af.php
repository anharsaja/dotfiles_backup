                        ...
                        <div class="col-sm order-2 order-sm-1">
                            ...
                            <i class="fas fa-user"></i>
                                ...
                                <div class="flex-grow-1">
                                    <div>
                                        <h5 class="font-size-19 mb-1">anhar</h5>
                                        <p class="text-muted font-size-13">anhar@mail</p>
                                    ...
                                    <div
                                        ...
                                        <div>
                                            <i
                                                class="mdi mdi-circle-medium me-1 text-success align-middle"></i>laki
                                        </div>
                                        <div><i
                                                class="mdi mdi-circle-medium me-1 text-success align-middle"></i>nganggur
                                        </div>
                                    </div>
                                </div>
                            </div>

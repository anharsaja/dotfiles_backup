                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select name="courses" class="form-select" id="basicpill-email-input">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select name="dosencourses" class="form-select" id="basicpill-email-input">
                                                        <option disabled selected>Pilih Kursus</option>
                                                        @foreach($dosencourses as $dosencourse)
                                                            <option value="{{ $dosencourse->id }}">{{ $dosencourse->lecturer->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>

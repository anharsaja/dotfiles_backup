                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select name="courcourses" class="form-select" id="courses">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select name="dosencourses" class="form-select" id="dosencourses">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="notes" id="basicpill-biografi-input" class="form-control" rows="4"
